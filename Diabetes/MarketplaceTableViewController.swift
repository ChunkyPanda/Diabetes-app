...
//  Diabetes
//
//  Created by Malhotra, Neil on 10/4/17.
...
class MarketplaceTableViewController: UITableViewController {
    ...
    @IBOutlet weak var hiwebView: UIWebView!
    ...
    override func viewDidLoad() {
        ...
        let wUrl = URL(string: "https://knowledge-place.wealthmeethealth.com/individual/be-smart/")
        
        hiwebView.loadRequest(URLRequest(url: wUrl!))
    }
